...
###Creating the Model
The first model fitted to the data was Random Forest. This was tried first as it was the method used in by Velloso et al., 2013 which was the original study. A number of settings were adjusted to decrease the processing time.
