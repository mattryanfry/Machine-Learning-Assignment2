...
###Creating the Model
The first model fitted to the data was Random Forest. This was tried first as it was the method used in by Velloso et al., 2013 which was the original study. A number of settings were adjusted to decrease the processing time, specifically within the trainControl options.
...
The testing set created was used to cross validate the data and the accuracy achieved was 99%. So the first model created was sufficiently accurate to use on the assignment quiz.
...
The model used to predict the quiz outcomes, which were predicted with 100% accuracy.
```{r prediction }
